...
<?php elseif($message == 3):?>
	<div  class="alert alert-dark" id="ajaxArticle" role="alert" aria-live="assertive" aria-atomic="true">Book Updated!</div>
<?php endif ?>
		  ...
		  <div class="card-body bg-dark text-white" >
			<h5 class="card-title"><b><?= esc($books_item['title']) ?></b></h5>
			 ...
			 <div class=" btn-fluid btn-group" role="group" aria-label="Basic example">
				<a href="<?=base_url()?>/books/delete/<?= esc($books_item['bookId'], 'url') ?>" class="btn btn-danger text-white"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
				<path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
				</svg> Delete</a>
				<button class="btn btn-outline-secondary text-dark" onclick="getData('<?= esc($books_item['bookId'], 'url') ?>')"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-valentine2" viewBox="0 0 16 16">
				...
				<a href="<?=base_url()?>/books/amend/<?= esc($books_item['bookId'], 'url') ?>" class="btn btn-outline-warning text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-hypnotize" viewBox="0 0 16 16">
				...
				<a href="<?=base_url()?>/books/view/<?= esc($books_item['bookId'], 'url') ?>" class="btn btn-outline-primary text-black"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
...
<script>
	function getData(bookId) {
		...
		// Fetch data
		fetch('http://mi-linux.wlv.ac.uk/~1606628/ci4-demo/public/ajax/get/' + bookId)
