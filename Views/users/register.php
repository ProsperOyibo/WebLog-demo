...
<form action="<?=base_url()?>/users/register" method="post">
	...
	<div class="mb-3">
		...
		<input class="form-control" placeholder="Enter your First name" type="text" name="first_name" required /><br />
	</div>
	<div class="mb-3">
		<label for="last_name" >Last Name</label>
		<input class="form-control" placeholder="Enter your Last name" type="text" name="last_name"required  /><br />
	</div>
	<div class="mb-3">
